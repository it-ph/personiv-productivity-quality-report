<table>
	<tr>
		<th colspan="{{count($department->beginner) + 1}}" align="center">Targets</th>
	</tr>
	<!-- Headers -->
	<tr>
		<th align="center">Productivity</th>
		@foreach($report->project->positions as $position)
	...
	<tr>
		...
		@foreach($department->beginner as $beginner)
	...
	<tr>
		...
		@foreach($department->moderately_experienced as $moderately_experienced)
	...
	<tr>
		...
		@foreach($department->experienced as $experienced)
	...
	<tr>
		...
		@foreach($department->quality as $quality)
