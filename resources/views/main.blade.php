...
<body>
	...
	<div class="main-view hidden-custom" ng-controller="homePageController" ng-init="show()" id="main">
		<md-content flex layout="column" layout-align="center center" class="full-height-min main-content">
			<a href="/">
				<img show-gt-md hide-md hide-sm src="{{url('/assets/img/2Color-Logo_247px-1024x195_white.png')}}" alt="Personiv Logo" class="personiv-logo">
				<img show-sm show-md hide-gt-md src="{{url('/assets/img/2Color-Favicon_512x512-1-raw_white.png')}}" alt="" class="personiv-logo">
			</a>
